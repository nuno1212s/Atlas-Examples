...
pub fn init_client_config<RF, D, NT, >(client_mode: UnorderedClientMode, network_config: MioConfig, reconfig: ReconfigurableNetworkConfig) -> Result<ClientConfig<RF, D, NT>> {
    Ok(ClientConfig {
